                                ...
                                <div class="card-block">
                                    ...
                                    <form method="POST" action="cetak_ketua.php" target="_Blank">
                                        <table class="display datatable-pagination table table-stripped" cellspacing="0" width="100%">
                                            ...
                                            <?php  
                                                $query = mysqli_query($koneksi,"SELECT ketua_kon.`id_ptki`,ketua_kon.`nm_ketua`,ketua_kon.`foto`,ptki.`nm_ptki`,ptki.`nm_ptki` FROM ketua_kon JOIN ptki ON ketua_kon.`id_ptki` = ptki.`id_ptki`");
                                                $no = 1;
