                                ...
                                <div class="card-block">
                                    ...
                                    <form method="POST" action="cetak_kontingen.php" target="_Blank">
                                        <table class="display datatable-pagination table table-stripped" cellspacing="0" width="100%">
                                            ...
                                            <?php  
                                                $query_peserta = mysqli_query($koneksi,"SELECT kontingen.`id_kontingen`,kontingen.`nm_kontingen`,cabang_lomba.`nm_lomba`,cabang_lomba.`peserta_lomba` FROM kontingen JOIN cabang_lomba ON kontingen.`id_cablom` = cabang_lomba.`id_cablom`");
                                                $no = 1;
                                                    while ($data_peserta = mysqli_fetch_array($query_peserta)) {
                                                    $id = $data_peserta['id_kontingen'];
                                                    // echo $id;
                                            ?>
                                                <tr>
                                                    <td align="center"><input name="selector[]" type="checkbox" value="<?php echo $id; ?>"></td>
                                                    <!-- <td align="center"><?php echo $no++; ?></td> -->
                                                    <td><?php echo $data_peserta['nm_kontingen']; ?></td>
                                                    <td><?php echo $data_peserta['nm_lomba']; ?></td>
                                                    <td><?php echo $data_peserta['peserta_lomba']; ?></td>
