...
<body>
                                ...
                                <div class="card-block">
                                    <h5 class="text-bold card-title">
                                        <div class="row no-gutters">
                                            <div class="col-sm-9">Data Panitia Koordinator</div>
                                            <div class="col-sm-3">
                                                <a href="#" class="btn btn-success btn-sm" data-toggle="modal" data-target="#koordinator"  title="Input Panitia Lomba"  style="color: white;"><i class="fa fa-plus position-left"></i>Tambah Data</a>
                                                <a href="cetak_koordinator.php" target="_blank" class="btn btn-warning btn-sm" data-toggle="tooltip" title="Cetak Data PTKIN"  style="color: white;"><i class="fa fa-print position-left"></i>Cetak</a>
                                            </div>
                                        </div>
                                    </h5>
                                    <table class="display datatable-pagination table table-stripped" cellspacing="0" width="100%">
                                        ...
                                        <?php  
                                            $query = mysqli_query($koneksi,"SELECT id_koor,nm_koor,nip,no_hp,jabatan,koordinator FROM pnt_koor");
                                            $no = 1;
    ...
    <!-- Modal koordinator -->
        <div id="koordinator" class="modal fade" role="dialog">
            <div class="modal-dialog" style="margin-top: 10%;">
                <div class="modal-content" style="border-radius: 5px;">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" style="margin-left: 10px;">&times;</button>
                        <h4 class="modal-title" style="margin-right: 20%;">Input Panitia Koordinator</h4>
                    </div>
                    <div class="modal-body" style="padding-bottom: 10px;">
                        <form method="POST" action="proses_koor.php" class="margin-top-20"  enctype="multipart/form-data">
                            <?php 
                                //membuat kode
                                $cari_kode = mysqli_query($koneksi, "SELECT max(id_koor) FROM pnt_koor"); //membuat variable query pada koneksi table
                                ...
                                if ($data_kode) { //kondisi, jika pada data array id_kontingen
                                    ...
                                    $hasil_kode = "KOOR".str_pad($kode, 2, "0", STR_PAD_LEFT); //menampilkan data CBL, nilai 3 itu baris data 
                            ...
                            <div class="form-group">
                                 <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="hidden" name="id_koor" value="<?php echo $hasil_kode ?>">
                                        <input type="text" name="nm_koor" class="form-control" required="">
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="control-label">Panitia Koordinator</label>
                                        <select id="inputState" class="form-control" name="koordinator">
                                            <option >-- Pilih --</option>                                        
                                            <option value="Sekretariat">Sekretariat</option>                                        
                                            <option value="Pendaftaran">Pendaftaran</option>                                        
                                            <option value="Pendataan Peserta">Pendataan Peserta</option>                                        
                                            <option value="Pembukaan & Penutupan">Pembukaan & Penutupan</option>                                        
                                            <option value="Sarpras & Transportasi">Sarpras & Transportasi</option>                                        
                                        </select>
                                    </div>
                                    <div class="col-md-6">
