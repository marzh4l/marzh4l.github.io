...
<body>
	...
	<hr>
	<h5 align="center">DAFTAR NAMA-NAMA PERGURUAN TINGGI KEAGAMAAN ISLAM NEGERI (PTKIN)<br> PEKAN KREATIVITAS MAHASISWA UIN RADEN FATAH 2018</h5>
	<table align="center" border="1" cellspacing="0" >

		
            <tr align="center" bgcolor="#5974FA">
                <th width="30" height="20">No</th>
                <th align="center" width="100">Kategori</th>
                <th width="300">Nama PTKIN</th>
	...
	<br><br><br><br>
	<p align="center">Mengetahui<br><br><br><br><br><br><b><?php echo 'xxxxxxxxxxxxxxxxxx'; ?></b></p>
</body>
</html>
<?php  
	$filename="Daftar Data PTKIN.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya  
	//==========================================================================================================  
