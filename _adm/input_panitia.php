...
<body>
                                ...
                                <div class="card-block">
                                    <h5 class="text-bold card-title">
                                        <div class="row no-gutters">
                                            <div class="col-sm-9">Data Panitia Perlombaan</div>
                                            <div class="col-sm-3">
                                                <a href="#" class="btn btn-success btn-sm" data-toggle="modal" data-target="#perlombaan"  title="Input Panitia Lomba"  style="color: white;"><i class="fa fa-plus position-left"></i>Tambah Data</a>
                                                <a href="cetak_panitia.php" target="_blank" class="btn btn-warning btn-sm" data-toggle="tooltip" title="Cetak Data PTKIN"  style="color: white;"><i class="fa fa-print position-left"></i>Cetak</a>
                                            </div>
                                        </div>
                                    </h5>
                                    <table class="display datatable-pagination table table-stripped" cellspacing="0" width="100%">
                                        ...
                                        <?php  
                                            $query = mysqli_query($koneksi,"SELECT nm_panitia,nim,no_hp,jurusan,nm_lomba FROM pnt_lomba");
                                            $no = 1;
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><?php echo $no ++; ?></td>
                                                <td><?php echo $data['nm_panitia']; ?></td>
    ...
    <!-- Modal perlombaan -->
        <div id="perlombaan" class="modal fade" role="dialog">
            <div class="modal-dialog" style="margin-top: 10%;">
                <div class="modal-content" style="border-radius: 5px;">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" style="margin-left: 10px;">&times;</button>
                        <h4 class="modal-title" style="margin-right: 20%;">Input Panitia Perlomba</h4>
                    </div>
                    <div class="modal-body" style="padding-bottom: 10px;">
                        <form method="POST" action="proses_pntlomba.php" class="margin-top-20"  enctype="multipart/form-data">
                            <?php 
                                //membuat kode
                                $cari_kode = mysqli_query($koneksi, "SELECT max(id_panitia) FROM pnt_lomba"); //membuat variable query pada koneksi table
                                ...
                                if ($data_kode) { //kondisi, jika pada data array id_kontingen
                                    ...
                                    $hasil_kode = "PNT".str_pad($kode, 2, "0", STR_PAD_LEFT); //menampilkan data CBL, nilai 3 itu baris data 
                            ...
                            <div class="form-group">
                                 <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="hidden" name="id_panitia" value="<?php echo $hasil_kode ?>">
                                        <input type="text" name="nm_panitia" class="form-control" required="">
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select id="inputState" class="form-control" name="nm_lomba">
                                            <option >-- Pilih --</option>
                                        <?php  
