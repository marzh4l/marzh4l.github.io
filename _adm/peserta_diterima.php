                                ...
                                <div class="card-block">
                                    ...
                                    <form method="POST" action="cetak_official.php" target="_Blank">
                                        <table class="display datatable-pagination table table-stripped" cellspacing="0" width="100%">
                                            ...
                                            <?php  
                                                $query = mysqli_query($koneksi,"SELECT kontingen.`id_kontingen`,kontingen.`nm_kontingen`,kontingen.`nim`,cabang_lomba.`nm_lomba`,berkas.`ss`,ptki.`nm_ptki` FROM kontingen JOIN cabang_lomba ON kontingen.`id_cablom` = cabang_lomba.`id_cablom`JOIN berkas ON kontingen.`id_kontingen` = berkas.`id_kontingen` JOIN ptki ON cabang_lomba.`id_ptki` = ptki.`id_ptki` WHERE kontingen.`status` = 'TRUE'");
                                                $no = 1;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><p style="color: green">DATA DITERIMA</p></td>
                                                </tr>
                                            <?php } ?>                                            
                                            </tbody>
                                        </table>
