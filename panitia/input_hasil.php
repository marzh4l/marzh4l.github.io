            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                        <div class="col-lg-12">
                            ...
                            <p>
                                Hasil Pertandingan Kontingen PTKI Cabang Lomba <?php echo $data['nm_ptki']; ?>.
                            </p>
                        </div>
                    </div>
                    <?php
                                ...
                                <div class="card-block">
                                    ...
                                    <form method="POST" action="proses_cablom.php" class="margin-top-20">
                                        <div class="form-group">
                                            <label class="control-label">Juara 1</label>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">Juara 2</label>
                                            <select id="inputState" class="form-control" name="peserta_lomba" required="required" aria-required="true">
                                                <option disabled selected hidden>-- Pilih --</option>
                                                <option value="Putra"></option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">Juara 3</label>
                                            <select id="inputState" class="form-control" name="peserta_lomba" required="required" aria-required="true">
                                                <option disabled selected hidden>-- Pilih --</option>
                                                <option value="Putra"></option>
                                            </select>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-block">
                                    <div class="row">                                        
                                        <div class="col-sm-7">                                            
                                            <h5 class="text-bold card-title">Data Peserta</h5>
                                        </div>
