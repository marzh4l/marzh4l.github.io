        ...
        <ul class="navigation">
            ...
            <div class="content-wrapper">
                <div class="content">
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 class="card-title">Daftar Official</h4>
                            <p>
                                ...
                                <div class="card-block">
                                    ...
                                    <form method="POST" action="cetak_official.php" target="_Blank">
                                        ...
                                        <table class="display datatable-pagination table table-stripped" cellspacing="0" width="100%">
                                            ...
                                            <?php  
                                                $query = mysqli_query($koneksi,"SELECT official.`id_official`,official.`nm_official`,cabang_lomba.`nm_lomba`,cabang_lomba.`peserta_lomba` FROM official JOIN cabang_lomba ON official.`id_cablom` = cabang_lomba.`id_cablom` WHERE `id_ptki` = '$data[id_ptki]'");
                                                $no = 1;
