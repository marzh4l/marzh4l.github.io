<?php 
    ...
    $query = mysqli_query($koneksi,"SELECT id_ptki,nm_ptki,nm_adm,logo_ptki FROM ptki WHERE password = '$password' AND username = '$username' OR email = '$email'");
                        ...
                        <div class="col-md-7">
                            <div class="card">
                                <div class="card-block">
                                    <h4 class="card-title">Selamat Datang di Halaman Dashboard PKM PTKIN 1 se-Sumatera 2018</h4>
                                    <p>
                                        Tahapan-tahapan pendaftaran :
                                        <ul>
                                            <li>Ketua Kontingen</li>
                                            <li>Cabang Lomba Pertandingan</li>
                                            <li>perserta kontingen dari masing-masing cabang lomba</li>
                                            <li>Official Dari masing-masing cabang perlombaan tersebut</li>
                                        </ul>
                                    </p>
                                </div>
                            </div>
