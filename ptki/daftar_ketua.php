            ...
            <div class="content-wrapper">
                ...
                <?php } ?>
                    <div class="row">
                        ...
                        <div class="col-md-7">
                        <?php
                            $query = mysqli_query($koneksi,"SELECT id_ketua,id_ptki,nm_ketua,nip,no_hp,jabatan,jenis_kelamin,foto,tgl FROM ketua_kon WHERE id_ptki = '$data[id_ptki]'"); 
                            $data_ketua = mysqli_fetch_array($query);
                            if($data_ketua['id_ptki'] == $data['id_ptki']) {
                        ?>                        
                        <div class="card">
                                <div class="card-block form-horizontal" style="padding: 10%">
                                    <!-- <h5 class="text-bold card-title">Ketua Kontingen</h5> -->
                                    <img src="<?php echo $data_ketua["foto"]; ?>" alt="" class="user-img" style="width: 30%; margin-left: 40%;">
                                        ...
                                        <div class="form-group row margin-top-30">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" value="<?php echo $data_ketua['nm_ketua']; ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-4">
                                                <label class="control-label col-form-label">NIP</label>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" value="<?php echo $data_ketua['nip']; ?>" readonly>
                                                </div>                                               
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" value="<?php echo $data_ketua['jenis_kelamin']; ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" value="<?php echo $data_ketua['tgl']; ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-4">
                                                <label class="control-label col-form-label">Jabatan</label>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" value="<?php echo $data_ketua['jabatan']; ?>" readonly> 
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-4">
                                                <label class="control-label col-form-label">Nomor Hp</label>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" value="<?php echo $data_ketua['no_hp']; ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">   
                                            ...
                                            <div class="col-md-8">
                                            <!-- <a href="cetak_ketua.php?id=<?php echo $data_ketua['id_ptki']; ?>" target="_black" class="btn btn-outline-primary btn-rounded btn-xl" data-toggle="tooltip" data-placement="top" title="Cetak"><i class="fa fa-print"></i></a> -->
                                            <a href="edit_ketua.php?id=<?php echo $data_ketua['id_ptki'];?>&nama=<?php echo $data_ketua['nm_ketua'];?>&nip=<?php echo $data_ketua['nip'];?>&jk=<?php echo $data_ketua['jenis_kelamin'];?>&tgl=<?php echo $data_ketua['tgl'];?>&jabatan=<?php echo $data_ketua['jabatan'];?>&no_hp=<?php echo $data_ketua['no_hp'];?>" class="btn btn-outline-primary btn-rounded btn-xl" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
                                            </div>
                                        </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-block">
                                    ...
                                    <form method="POST" action="proses_kekon.php" class="margin-top-20" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label class="control-label">Nama <i style="font-size:20px; color:red"> *</i></label>
                                            <!-- variable id ptki -->
                                            <input type="hidden" name="id_ptki" value="<?php echo $data["id_ptki"]; ?>" class="form-control">

                                            <input type="text" name="nm_ketua" class="form-control" required="" placeholder="Ketikan Nama Lengkap">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="nip" class="form-control" required placeholder="Ketikan nomor NIP">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="control-label" style="margin-right: 90px;">Jenis Kelamin <i style="font-size:20px; color:red"> *</i></label>
                                                    <label class="custom-control custom-radio">
                                                        <input id="radio1" name="jenis_kelamin" value="Laki-laki" type="radio" class="custom-control-input">
                                                        <span class="custom-control-indicator"></span>
                                                        <span class="custom-control-description">Laki-laki</span>
                                                    </label>
                                                    <label class="custom-control custom-radio">
                                                        <input id="radio2" name="jenis_kelamin" value="Perempuan" type="radio" class="custom-control-input">
                                                        <span class="custom-control-indicator"></span>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="tgl" class="form-control datepicker" style="background-color: #fff;" required placeholder="Masukan Tanggal Lahir">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="control-label">Foto <i style="font-size:20px; color:red"> *</i><i style="font-size:10px; font-size:10px; color:blue"> Format : .jpg/.jpeg/.png</i></label>
                                        ...
                                        <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <!-- <input type="text" name="jabatan" class="form-control" required placeholder="Masukan Jabatan anda"> -->
                                                    <select id="inputState" class="form-control" name="nm_ptki">
                                                <option >-- Pilih --</option>
                                                <option>Wakil Rektor III</option>
                                                <option>Wakil Ketua III</option>
                                            </select>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="control-label">No /HP <i style="font-size:20px; color:red"> *</i></label>
                                                    <input type="text" name="no_hp" class="form-control" required placeholder="Masukan Nomor Telpon atau HP">
                                                </div>
                                            </div>
                                        </div>                                       
